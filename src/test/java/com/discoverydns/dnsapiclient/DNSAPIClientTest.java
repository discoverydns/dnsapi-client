...
public class DNSAPIClientTest {
    ...
    @Test
    public void shouldThrowExceptionWhenProcessingCommandIfClientIsClosed() throws Throwable {
        dnsapiClient.close();
    ...
    @Test
    public void shouldDelegateToBlockingCommandExecutorToProcessCommand() throws Throwable {
        dnsapiClient.process(mockCommand);
    ...
    public void shouldReturnExpectedResponse() throws Throwable {
        ...
        when(mockBlockingCommandExecutor.process(eq(mockCommand),
                any(DNSAPIClientCommandMetaData.class))).thenReturn(mockResponse);
