...
public class CommandInterceptorChainTest {
    ...
    @Mock
    private Iterator<? extends CommandInterceptor> mockInterceptorChainIterator;
    @Mock
    ...
    public void setup() throws Throwable {
        commandInterceptorChain = new CommandInterceptorChain(
                mockCommand, mockCommandMetaData,
                mockInterceptorChainIterator, mockCommandHandler);
    }

    @Test
    public void shouldDelegateToNextInterceptorIfNotLastInChain() throws Throwable {
        when(mockInterceptorChainIterator.hasNext()).thenReturn(true);
        when(mockInterceptorChainIterator.next()).thenReturn(mockNextCommandInterceptorInChain);
    ...
    @Test
    public void shouldDelegateToCommandHandlerToProcessCommandIfLastInChain() throws Throwable {
