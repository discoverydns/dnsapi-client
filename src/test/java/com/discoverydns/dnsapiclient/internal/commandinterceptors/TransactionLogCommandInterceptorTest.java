...
public class TransactionLogCommandInterceptorTest {
    ...
    @Test
    public void shouldJustProceedRestOfTheChainIfTransactionLogHandlerIsNull() throws Throwable {
        new TransactionLogCommandInterceptor(null).intercept(
    ...
    public void shouldProceedRestOfTheChain() throws Throwable {
        transactionLogCommandInterceptor.intercept(
                mockCommand, mockCommandMetaData, mockCommandInterceptorChain);
    ...
    public void shouldLogCommandSuccess() throws Throwable {
        ...
        verify(mockTransactionLogHandler).logTransaction(
                mockCommand, mockResponse, mockCommandMetaData);
    }
    ...
    public void shouldLogCommandFailure() throws Throwable {
        ...
        try {
            ...
            verify(mockTransactionLogHandler).logFailedTransaction(
                    mockCommand, mockRuntimeException, mockCommandMetaData);
            throw t;
        }
    }
}
