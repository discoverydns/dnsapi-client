...
public class MessageAcknowledgeCommandHandlerTest {
	...
	public void setup() throws Throwable {
		when(mockBaseWebTarget.path("messages/{messageId}/acknowledge"))
				.thenReturn(mockMessageAcknowledgeTarget);

		messageAcknowledgeCommandHandler = new MessageAcknowledgeCommandHandler(
				mockBaseWebTarget);
	}
	...
	public void shouldGetTargetRelativeToProvidedCommand() {
		...
		assertEquals(resultingWebTarget,
				messageAcknowledgeCommandHandler.getWebTarget(
	...
	public void shouldReturnWithEntityInvocationBuildInvoker() {
		assertThat(messageAcknowledgeCommandHandler.getInvocationBuildInvoker(
				mockMessageAcknowledgeCommand, mockCommandMetaData),
	...
	public void shouldReturnExpectedResponse() throws Throwable {
		...
		MessageGetResponse commandResponse = messageAcknowledgeCommandHandler
