...
public class NameServerSetGetCommandHandlerTest {
    ...
    public void setup() throws Throwable {
        ...
        nameServerSetGetCommandHandler =
                new NameServerSetGetCommandHandler(mockBaseWebTarget);
    }
    ...
    public void shouldGetTargetRelativeToProvidedCommand() {
        ...
        when(mockNameServerSetGetTarget.resolveTemplate("nameServerSetId", idOrName))
    ...
    public void shouldReturnNoEntityInvocationBuilderFactory() {
        assertThat(
                nameServerSetGetCommandHandler.getInvocationBuilderFactory(
                        mockNameServerSetGetCommand, mockCommandMetaData),
    ...
    public void shouldReturnNoEntityInvocationBuildInvoker() {
        assertThat(
                nameServerSetGetCommandHandler.getInvocationBuildInvoker(
                        mockNameServerSetGetCommand, mockCommandMetaData),
    ...
    public void shouldReturnExpectedNameServerSetGetResponse() {
        ...
        NameServerSetGetView mockNameServerSetGetView
                = mock(NameServerSetGetView.class);
        ...
        NameServerSetGetResponse commandResponse =
                nameServerSetGetCommandHandler.getCommandResponse(
