...
/**
 * Example of sending an ZoneReTransferAXFRCommand and receiving an ZoneReTransferAXFRResponse
 * @author Arnaud Dumont
 */
public class ZoneReTransferAXFRCommandExample {
    ...
    public static void main(String[] args) {
        ...
        final ZoneReTransferAXFRCommand command =
                new ZoneReTransferAXFRCommand.Builder()
                        .withId("<my-zone-id>")
                        .build();

        //Send command to server and receive response
        try {
            Response<ZoneReTransferAXFRResponse> response = client.process(command);
