...
public class AccountGetCommand {
	...
	public static class Builder {
         ...
         * @param idOrIdentifier The UUID or identifier of the Account to look for
        ...
        /**
         * Builds the {@link AccountGetCommand} from the parameters set on the {@link Builder}.
    ...
    /**
     * @return The UUID or identifier of the Account to look for, set on the command.
     */
