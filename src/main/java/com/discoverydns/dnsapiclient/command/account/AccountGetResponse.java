 ...
 * from the DNSAPI server subsequently to the sending of a {@link AccountGetCommand},
 * describing the details of the retrieved Account.
 *
 * An Account represents a company or organisation who has the ability
 * to connect to and interact with the DNSAPI server, through its users.
 *
 * @author Chris Wright
 */
...
public class AccountGetResponse {
    ...
    /**
     * @return The Account modification version
     */
    ...
    /**
     * @return The 3 letter currency code of the currency used for billing operations on this account
     */
    ...
    /**
     * @return The date on which the monthly minimum commitment will start being charged
     */
    ...
    /**
     * @return The unique identifier of the Account who last updated this Account
     */
