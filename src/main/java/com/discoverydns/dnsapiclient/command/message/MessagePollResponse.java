...
public class MessagePollResponse {
	...
	/**
	 * @return The oldest queued Message on the DNSAPI server, or null if no
	 *         message was found
	 */
	@JsonProperty("message")
	public MessageRecord getMessageRecord() {
		return messagePollView.getMessageRecord();
	}

	/**
	 * @return The count of outstanding Messages on the DNSAPI server, in the
	 *         Account's message queue
	 */
	@JsonProperty("outstandingMessageCount")
	public Long getOutstandingMessageCount() {
		return messagePollView.getOutstandingMessageCount();
	}
}
